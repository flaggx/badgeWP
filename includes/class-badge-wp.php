...
class Badge_Wp {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Badge_Wp_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'BADGE_WP_VERSION' ) ) {
			$this->version = BADGE_WP_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'badge-wp';
	 ...
	 *
	 * - Badge_Wp_Loader. Orchestrates the hooks of the plugin.
	 * - Badge_Wp_i18n. Defines internationalization functionality.
	 * - Badge_Wp_Admin. Defines all hooks for the admin area.
	 * - Badge_Wp_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-badge-wp-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-badge-wp-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-badge-wp-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-badge-wp-public.php';

		$this->loader = new Badge_Wp_Loader();
	 ...
	 *
	 * Uses the Badge_Wp_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Badge_Wp_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Badge_Wp_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Badge_Wp_Loader    Orchestrates the hooks of the plugin.
	 */
